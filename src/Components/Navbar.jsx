...
import ecoeatsreal from '../Images/ecoeatslogoreal.png'
...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-white/40 rounded-2xl z-40 sticky top-10 backdrop-blur-xl m-6 flex items-center mx-10 sm:mx-20 lg:mx-40">
